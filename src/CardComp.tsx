...
const CardComp = ({
    ...
    return (
        <div className="bg-black text-white p-6 rounded-[40px] flex flex-col md:flex-row gap-6 max-w-2xl mx-auto h-[500px] w-[850px] " style={{paddingTop:"30px"}}>
